...
| **SEO real (SSR/prerender)** | El sitio es SPA pura; para que Google vea title/OG por ruta hace falta migrar a SSR (Next.js) o prerender. Es un cambio de arquitectura, no un parche. Decisión de negocio (¿cuánto importa el tráfico orgánico?). | Grande |
